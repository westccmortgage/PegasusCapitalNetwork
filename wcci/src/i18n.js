...
// Native language names (autonyms) shown in the language sheet — never localized,
// never shown as "ZH".
export const LANG_NATIVE = { en: 'English', es: 'Español', ru: 'Русский', 'zh-CN': '简体中文' };
...
export const CONTACT_UI = {
  en: {
    ...
    platformExplainer: 'WCCI is the mortgage strategy platform operated for West Coast Capital Mortgage Inc.',
    menuLabel: 'Menu',
    officeLabel: 'Office',
    directLabel: 'Direct',
    emailLabel: 'Email',
    ...
    contactTitle: 'Contact West Coast Capital Mortgage',
    directContactLabel: 'Direct — Anatoliy Kanevsky',
    sendEmail: 'Send Email',
    openMenuAria: 'Open menu',
    startNewScenario: 'Start New Scenario',
    startNewScenarioAria: 'Start new scenario',
    aboutCompany: 'About West Coast Capital Mortgage',
    contact: 'Contact',
    clearSaved: 'Clear Saved Information',
    cancel: 'Cancel',
    confirmNewTitle: 'Start a new scenario?',
    confirmNewBody: 'This clears the current conversation and profile. This can’t be undone.',
    clearSavedTitle: 'Clear saved information?',
    clearSavedBody: 'This permanently clears your saved conversation, profile, and preferences on this device.',
    licensedInfo: 'Company & Licensing',
  ...
  es: {
    ...
    platformExplainer: 'WCCI es la plataforma de estrategia hipotecaria operada para West Coast Capital Mortgage Inc.',
    menuLabel: 'Menú',
    officeLabel: 'Oficina',
    directLabel: 'Directo',
    emailLabel: 'Correo',
    ...
    contactTitle: 'Contactar a West Coast Capital Mortgage',
    directContactLabel: 'Directo — Anatoliy Kanevsky',
    sendEmail: 'Enviar correo',
    openMenuAria: 'Abrir menú',
    startNewScenario: 'Iniciar nuevo escenario',
    startNewScenarioAria: 'Iniciar nuevo escenario',
    aboutCompany: 'Acerca de West Coast Capital Mortgage',
    contact: 'Contacto',
    clearSaved: 'Borrar información guardada',
    cancel: 'Cancelar',
    confirmNewTitle: '¿Iniciar un nuevo escenario?',
    confirmNewBody: 'Esto borra la conversación y el perfil actuales. No se puede deshacer.',
    clearSavedTitle: '¿Borrar la información guardada?',
    clearSavedBody: 'Esto borra de forma permanente su conversación, perfil y preferencias guardados en este dispositivo.',
    licensedInfo: 'Compañía y licencias',
  ...
  ru: {
    ...
    platformExplainer: 'WCCI — платформа ипотечной стратегии, работающая для West Coast Capital Mortgage Inc.',
    menuLabel: 'Меню',
    officeLabel: 'Офис',
    directLabel: 'Прямой',
    emailLabel: 'Эл. почта',
    ...
    contactTitle: 'Связаться с West Coast Capital Mortgage',
    directContactLabel: 'Прямой — Anatoliy Kanevsky',
    sendEmail: 'Написать письмо',
    openMenuAria: 'Открыть меню',
    startNewScenario: 'Начать новый сценарий',
    startNewScenarioAria: 'Начать новый сценарий',
    aboutCompany: 'О West Coast Capital Mortgage',
    contact: 'Контакты',
    clearSaved: 'Очистить сохранённые данные',
    cancel: 'Отмена',
    confirmNewTitle: 'Начать новый сценарий?',
    confirmNewBody: 'Это очистит текущий разговор и профиль. Действие необратимо.',
    clearSavedTitle: 'Очистить сохранённые данные?',
    clearSavedBody: 'Это навсегда удалит сохранённые разговор, профиль и настройки на этом устройстве.',
    licensedInfo: 'Компания и лицензии',
  ...
  'zh-CN': {
    ...
    platformExplainer: 'WCCI 是为 West Coast Capital Mortgage Inc. 运营的房贷策略平台。',
    menuLabel: '菜单',
    officeLabel: '办公室',
    directLabel: '直线电话',
    emailLabel: '电子邮件',
    ...
    contactTitle: '联系 West Coast Capital Mortgage',
    directContactLabel: '直线电话 — Anatoliy Kanevsky',
    sendEmail: '发送邮件',
    openMenuAria: '打开菜单',
    startNewScenario: '开始新的方案',
    startNewScenarioAria: '开始新的方案',
    aboutCompany: '关于 West Coast Capital Mortgage',
    contact: '联系方式',
    clearSaved: '清除已保存的信息',
    cancel: '取消',
    confirmNewTitle: '开始新的方案？',
    confirmNewBody: '这将清除当前的对话和档案，且无法撤销。',
    clearSavedTitle: '清除已保存的信息？',
    clearSavedBody: '这将永久清除本设备上已保存的对话、档案和偏好设置。',
    licensedInfo: '公司与执照信息',
...
export const T = {
  en: {
    ...
    greeting: `Welcome. I'm your AI-assisted mortgage strategist from West Coast Capital Mortgage.\n\nTell me what you're trying to do, and we'll work through it together. No credit pull, no obligation.\n\nHow can I help today?`,
  },
  es: {
    brand: 'West Coast Capital',
    brandBy: 'de',
    ...
    greeting: `Bienvenido. Soy su estratega hipotecario asistido por IA de West Coast Capital Mortgage.\n\nCuénteme qué desea lograr y lo resolvemos juntos. Sin consulta de crédito, sin compromiso.\n\n¿Cómo puedo ayudarle hoy?`,
  },
  ru: {
    brand: 'West Coast Capital',
    brandBy: 'от',
    ...
    greeting: `Добро пожаловать. Я ваш ипотечный стратег с поддержкой ИИ от West Coast Capital Mortgage.\n\nРасскажите, что вы хотите сделать, и мы разберёмся вместе. Без проверки кредита, без обязательств.\n\nЧем могу помочь сегодня?`,
  },
  'zh-CN': {
    brand: 'West Coast Capital',
    brandBy: '由',
    ...
    greeting: `欢迎。我是来自 West Coast Capital Mortgage 的 AI 辅助房贷策略顾问。\n\n告诉我您想要做什么，我们一起来规划。不查询信用，没有义务。\n\n今天我能为您做些什么？`,
  },
};
